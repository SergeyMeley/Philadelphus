...
{
    /// <summary>
    /// Чистая логика конвертера UtcToLocalTimeConverter (без привязки к UI-фреймворку).
    /// </summary>
    public static class UtcToLocalTimeLogic
    {
        /// <summary>
        ...
        private static readonly CultureInfo _russianCulture = new CultureInfo("ru-RU");
