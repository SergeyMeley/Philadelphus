...
{
    /// <summary>
    /// Чистая логика конвертера LastLaunchToDaysAgoConverter (без привязки к UI-фреймворку).
    /// </summary>
    public static class LastLaunchToDaysAgoLogic
    {
        /// <summary>
        /// Преобразует дату последнего запуска в человекочитаемую строку "N дней назад".
        /// </summary>
        ...
        private static string GetFormattedText(int days)
        {
            if (days == 0)
            {
