...
namespace Philadelphus.Core.Domain.ImportExport.Excel
{
    public class ConversionService
    {
        ...
        public WorkingTreeExportDTO ProcessFile(string filePath, bool createNewRoot, string rootNameInput)
        {
            var result = new WorkingTreeExportDTO
            {
                TreeNodes = new List<TreeNodeExportDTO>(),
                TreeLeaves = new List<TreeLeaveExportDTO>()
            };
            ...
            result.TreeRoot = new TreeRootExportDTO
            {
                Name = finalRootName,
            ...
            using (var workbook = new XLWorkbook(filePath))
            {
                foreach (var worksheet in workbook.Worksheets)
                {
                    ...
                    {
                        var leaf = new TreeLeaveExportDTO
                        {
