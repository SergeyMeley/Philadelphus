...
{
    public class PostgreEfShrubMembersInfrastructureRepository : PostgreEfInfrastructureRepositoryBase<ShrubMembersContext>, IShrubMembersInfrastructureRepository
    {
        ...
        protected override ShrubMembersContext GetNewContext() => new ShrubMembersContext(_connectionString);
        protected override DbSet<TEntity> GetDbSet<TEntity>(ShrubMembersContext context) where TEntity : class
        {
