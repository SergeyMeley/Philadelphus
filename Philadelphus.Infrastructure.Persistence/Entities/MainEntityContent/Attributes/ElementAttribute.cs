...
namespace Philadelphus.Infrastructure.Persistence.Entities.MainEntityContent.Attributes
{
    ...
    public class ElementAttribute : WorkingTreeMemberBase
    {
        ...
        /// <summary>
        /// Формула значения — единственный источник значения в приложении.
        /// </summary>
        ...
        /// <summary>
        /// Уникальные идентификаторы материализованного результата вычисления формулы коллекции.
        /// </summary>
        /// <remarks>
        /// Поле хранится только для запросов к БД и построения отчетов. При загрузке доменной модели
        /// оно не является источником значений: приложение вычисляет <see cref="ValueFormula" /> заново.
        /// </remarks>
